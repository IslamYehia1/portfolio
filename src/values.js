        ...
        <div className="secondPage">
          ...
          <div className="picture firstPicture">
            ...
            <div className="valueDescription">
              ...
              <h4>BRANDING</h4>
              <p>
                We believe that uniqueness is a necessity if one wants to be
                irreplaceable.
              </p>
              <p>
                We design, build, and communicate cohesive campaigns from start
                to finish with one goal in mind: to elevate your brand.
              </p>
            </div>
          </div>
          <div className="picture webSite">
            ...
            <div className="valueDescription">
              ...
              <p>
                We design, build, and diploy websites that are performant with
                an elegant sense of aesthetics.{" "}
              </p>
              <p>
                Our digital solutions are focused on creating a smooth customer
                experience and business efficiancy.
              </p>
            </div>
          </div>
          <div className="picture">
            ...
            <div className="valueDescription">
              ...
              <p>
                From website creation to content management we utilize the power
                of the cyberspace and social networking to strengthen your brand
                identity and presence.{" "}
              </p>
              <p>
                We offer different types of digital marketing services,
                including SEO, paid media, social media marketing, email
